...
from .models import Newspaper, Page, Article, RawPageData, RawCropData
...
class RawPageDataDocument(Document):
	...
	newspaper = fields.ObjectField(properties={
...
class RawCropDataDocument(Document):
	...
	class Django:
		model = RawCropData
		fields = []
		related_models = [Article, Page, Newspaper]
...
@registry.register_document
class NewspaperDocument(Document):
	class Index:
		name = 'newspaper-index'
